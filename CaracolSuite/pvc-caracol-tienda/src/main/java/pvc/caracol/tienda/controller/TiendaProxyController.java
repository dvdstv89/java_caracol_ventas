...
@RestController
@RequestMapping("/api/v1/tienda-proxy")
public class TiendaProxyController {

    private final ITiendaService tiendaService;
    private final ICintaAuditoraService cintaAuditoraService;

    @Autowired
    public TiendaProxyController(ITiendaService tiendaService, ICintaAuditoraService cintaAuditoraService) {
